...
-- Tiempo de generación: 25-03-2025 a las 14:06:55
...
CREATE TABLE `detalles_pedido` (
  ...
  `id_prod` int(11) DEFAULT NULL,
  `cant_prod` int(11) NOT NULL,
  `preciou_prod` decimal(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `pedidos` (
  ...
  `id_user` int(11) DEFAULT NULL,
  `total_pedi` decimal(10,2) NOT NULL,
  `f_pedi` timestamp NOT NULL DEFAULT current_timestamp(),
  `estado_pedi` enum('Pendiente','Enviado','Entregado','Cancelado') DEFAULT 'Pendiente'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `usuarios` (
  ...
  `rol_user` enum('CLIENTE','EMPRESA','ADMINISTRADOR') NOT NULL,
