...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 03:05:47
...
INSERT INTO `categorias` (`id_cate`, `nom_cate`, `activo`) VALUES
(1, 'Maquillaje', b'0'),
(2, 'Skincare', b'0'),
(3, 'Brochas', b'0'),
(4, 'Accesorios', b'0'),
...
INSERT INTO `metodos_pago` (`id_mpago`, `nom_mpago`, `activo`) VALUES
(1, 'Tarjeta de Crédito', b'0'),
(2, 'Transferencia Bancaria', b'0'),
(3, 'PayPal', b'0');
...
INSERT INTO `productos` (`id_prod`, `nom_prod`, `desc_prod`, `ref_prod`, `preciou_prod`, `stock_prod`, `id_cate`, `activo`) VALUES
(1, 'Labial Atena', 'Fórmula de', '425', '15000.00', 50, 1, b'0'),
(2, 'Pestañina Lux', 'Rímel de l', '543', '25000.00', 40, 1, b'0'),
(3, 'Serum Mate', 'Suaviza la', '45', '30000.00', 30, 2, b'0');
